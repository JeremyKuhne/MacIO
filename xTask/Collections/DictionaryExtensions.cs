...
public static class DictionaryExtensions
{
    ...
    ///  if the key already exists.
    /// </summary>
    /// <param name="source">The dictionary to update.</param>
    /// <param name="key">The key to add or update.</param>
    /// <param name="addValue">Value to use if adding.</param>
    /// <param name="updateValueFactory">
    ///  Value factory to use if updating (takes originalKey and originalValue, returns updatedValue).
    /// </param>
    /// <exception cref="ArgumentNullException">
    ///  <paramref name="key"/> or <paramref name="updateValueFactory"/> are null.
    /// </exception>
    ...
    /// <param name="addValue">Value to use if adding.</param>
    /// <param name="updateValueFactory">
    ///  Value factory to use if updating (takes originalValue, returns updatedValue).
    /// </param>
    /// <exception cref="ArgumentNullException">
    ///  <paramref name="key"/> or <paramref name="updateValueFactory"/> are null.
    /// </exception>
    ...
    /// <summary>
    ///  Adds a key/value pair if the key does not already exist, or updates the key/value pair if the key already exists.
    /// </summary>
    /// <param name="source">Target dictionary.</param>
    /// <param name="key">The key to add or update.</param>
    /// <param name="addValueFactory">Value factory to use if adding (takes originalKey and returns updatedValue).</param>
    /// <param name="updateValueFactory">Value factory to use if updating (takes originalKey and originalValue, returns updatedValue).</param>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="key"/>, <paramref name="addValueFactory"/>, or <paramref name="updateValueFactory"/> are null.</exception>
    /// <returns>The new value for the key.</returns>
    public static TValue AddOrUpdate<TKey, TValue>(
        ...
        TValue value)
    {
        ...
        {
            if (value?.Equals(entry.Value) ?? entry.Value is null)
            {
